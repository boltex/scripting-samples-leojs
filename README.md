...
To work directly with this repository and try out those scripts online, simply navigate to this scripting-samples repository on github at [https://github.com/boltex/scripting-samples-leojs](https://github.com/boltex/scripting-samples-leojs) and press `.` (period key).

## How to run sample scripts

[Install the LeoJS extension](https://code.visualstudio.com/docs/editor/extension-marketplace#_browse-for-extensions), right-click on the **scripting-samples.leojs** file in the explorer to open it with LeoJS, and see the **Introduction** node for more details on each sample script.
